...
const Feather = createLucideIcon("feather", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Scroll = createLucideIcon("scroll", __iconNode$1);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function DefinitionAccordion({ definitions }) {
  const [openIndex, setOpenIndex] = reactExports.useState(null);
  const toggle = (i) => {
    setOpenIndex((prev) => prev === i ? null : i);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: definitions.map((def, i) => {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground text-base pr-4", children: def.term }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-5 pt-3 bg-secondary/40 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/85 font-body text-sm leading-relaxed", children: def.explanation }) })
            }
          )
        ]
      },
...
function DetailPage({ doc, onBack }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-0 z-40 bg-white/90 backdrop-blur-sm border-b-2 border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6 py-4 flex items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-[2px] bg-gradient-to-r from-transparent via-primary/40 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground font-body", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Scroll, { className: "w-3.5 h-3.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Anushka Sharma" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-b from-secondary/60 to-white border-b-2 border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6 py-16 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-24 h-24 rounded-full bg-primary/10 border-2 border-primary/20 mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-11 h-11 text-primary", strokeWidth: 1.5 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl md:text-5xl font-bold text-foreground leading-tight mb-5", children: doc.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display italic text-lg text-primary/80 max-w-2xl mx-auto leading-relaxed", children: [
            "“",
            doc.introLine,
            "”"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground font-body", children: doc.teaser })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6 py-14 space-y-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground whitespace-nowrap", children: "Synopsis" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-[2px] bg-gradient-to-r from-primary/60 to-transparent" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base leading-relaxed text-foreground/85", children: doc.synopsis })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground whitespace-nowrap", children: "Key Definitions" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-[2px] bg-gradient-to-r from-primary/60 to-transparent" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body mb-5", children: "Click on any term below to expand its definition." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DefinitionAccordion, { definitions: doc.definitions })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground whitespace-nowrap", children: "Legal Provisions & Sections" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-[2px] bg-gradient-to-r from-primary/60 to-transparent" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4", children: doc.provisions.map((prov) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "section-badge mt-0.5 flex-shrink-0", children: prov.section }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-foreground/85 leading-relaxed pt-0.5", children: prov.description })
                ]
              },
              prov.section
            )) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "text-center py-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-[2px] bg-gradient-to-r from-transparent via-primary to-transparent mx-auto mb-10" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mb-6", children: "Access the complete document in its original form." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: doc.pdfLink,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t-2 border-border bg-secondary/30 py-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-muted-foreground", children: [
          "© ",
...
function DocumentCard({ doc, index: index2, onClick }) {
  const Icon2 = doc.icon;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      "data-ocid": `doc.item.${index2}`,
      onClick: () => onClick(doc),
      className: `card-animate card-animate-${index2} red-glow group w-full text-center cursor-pointer bg-white border-2 border-border rounded-2xl p-8 flex flex-col items-center gap-5 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 min-h-[220px]`,
      "aria-label": `Open ${doc.title}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-secondary flex items-center justify-center transition-all duration-300 group-hover:bg-primary group-hover:scale-110", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Icon2,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-primary/10 blur-md" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground leading-tight mb-2 group-hover:text-primary transition-colors duration-300", children: doc.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body leading-relaxed", children: doc.teaser })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto flex items-center gap-1.5 text-xs font-semibold text-primary opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-1 group-hover:translate-y-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Explore Document" }),
...
const documents = [
  {
    ...
    definitions: [
      ...
      },
      {
        ...
        explanation: "The party receiving and obligated to protect confidential information."
      },
      {
        term: "Transaction",
        explanation: "The potential business relationship or deal that the NDA facilitates."
      },
      {
        term: "Standstill Period",
        explanation: "A two-year period from the Effective Date during which neither party may seek to acquire the other's securities, assets, or corporate control."
      }
    ],
    provisions: [
      {
      ...
      {
        section: "Clause 2.1",
        description: "Non-Disclosure obligations; limited to directors, officers, legal counsel, advisors"
      },
      {
        section: "Clause 2.2",
        description: "Protection of Information: same standard of care as own confidential information, minimum reasonable care"
      },
      {
        section: "Clause 3",
        description: "Required Disclosure: notify the other party; seek protective treatment; disclose only what is legally required"
      },
      {
        section: "Clause 4",
        description: "Return or Destruction of Confidential Information upon written request"
      },
      {
        section: "Clause 5",
      ...
      {
        section: "Clause 6",
        description: "Standstill (2 years): prohibition on acquiring securities, making takeover attempts, soliciting proxies"
      },
      {
        section: "Clause 7",
        description: "Remedies: injunctive relief and equitable remedies available for breach"
      },
      {
        section: "Clause 8",
        description: "Term: 5 years; obligations survive for 5 years post-termination"
      },
      {
        section: "Clause 9",
  ...
  },
  {
    ...
    introLine: "In the pursuit of liberty, every word counts and every ground matters.",
    icon: Scale,
    pdfLink: "/assets/uploads/Bail-Application-2.pdf",
    synopsis: "This bail application was filed under Section 439 of the Code of Criminal Procedure, 1973 before the Court of Ms. Charu Aggarwal, ASJ-02, Central, Tis Hazari Courts, Delhi, on behalf of Accused No. 1, Manish Mittal, in FIR No. 42/2020 registered at PS Sarai Rohilla. The accused faces charges under Sections 354D (stalking), 506 (criminal intimidation), and 509 (outraging modesty of a woman) of the Indian Penal Code, as well as Sections 3(1)(r), 3(1)(s), 3(1)(w-ii), and 3(2Va) of the Scheduled Castes and Scheduled Tribes (Prevention of Atrocities) Act. The application strongly asserts the accused's innocence, challenges the veracity of the allegations as oral and unsubstantiated, highlights the accused's co-operation with police, and undertakes compliance with bail conditions including non-contact with witnesses.",
    definitions: [
      {
        term: "Bail",
        explanation: "Provisional release of an accused from custody upon furnishing security and undertaking to appear before the court."
      },
      {
        term: "Anticipatory Bail",
        explanation: "Pre-arrest bail granted under Section 438 CrPC in anticipation of arrest; already obtained by the accused in this case."
      },
      {
        term: "Chargesheet",
        explanation: "A formal document filed by the police before the court containing the charges against the accused after investigation; already filed in this case."
      },
      {
        term: "Surety",
        explanation: "A person who provides a financial guarantee to the court for the accused's appearance."
      },
      {
        term: "Framing of Charges",
        explanation: "The formal stage in a criminal trial where the court frames specific charges against the accused before trial proceeds."
      }
    ],
    provisions: [
      {
        section: "Section 439 CrPC",
        description: "Power of Sessions Court/High Court to grant bail in non-bailable offences (now under BNSS)"
      },
      {
        section: "Section 354D IPC",
        description: "Stalking: follows a woman and contacts her to foster personal interaction despite clear disinterest; punishable with imprisonment"
      },
      {
        section: "Section 506 IPC",
        description: "Criminal Intimidation: threatening another person with injury to cause alarm; punishable with imprisonment"
      },
      {
      ...
      },
      {
        ...
        description: "Offences of intentional insult, intimidation, and sexual abuse against members of SC/ST communities"
      }
    ]
  },
  {
    ...
    definitions: [
      ...
      },
      {
        ...
        explanation: "Rights guaranteed to Indian citizens under Part III of the Constitution (Articles 12-35), enforceable by courts."
      }
    ],
    provisions: [
      {
        section: "Article 21",
        description: "Right to Life and Personal Liberty, interpreted to include the right to access clean drinking water and a healthy environment (Subhash Kumar v. State of Bihar, 1991 1 SCC 598)"
      },
      {
        section: "Article 14",
        description: "Equality before the law; prohibition on arbitrary state action"
      },
      {
        section: "Article 226",
        description: "Power of High Courts to issue writs, including mandamus, for enforcement of fundamental and legal rights"
      },
      {
        section: "Section 9, Delhi Jal Board Act 1998",
        description: "Statutory duty of the Delhi Jal Board to ensure safe water supply"
      },
      {
        section: "Section 42, Delhi Municipal Corporation Act 1957",
        description: "Duty of MCD to ensure sanitation and protection of public health"
      },
      {
        section: "Subhash Kumar v. State of Bihar (1991) 1 SCC 598",
        description: "Right to life includes right to pollution-free water and air"
      },
      {
        section: "A.P. Pollution Control Board v. Prof. M.V. Nayudu (1999) 2 SCC 718",
        description: "Access to clean drinking water is fundamental to life; State duty to protect water resources"
      },
      {
        section: "Narmada Bachao Andolan v. Union of India (2000) 10 SCC 664",
        description: "Water as a basic human necessity; essential for enjoyment of Article 21 rights"
      }
    ]
  },
  {
    ...
    introLine: "Every campaign begins with a contract — the blueprint of a brand's promise.",
    icon: FileText,
    pdfLink: "/assets/uploads/Advertising-Agreement-4.pdf",
    synopsis: "This Master Marketing Agreement, dated March 2026, is between GroupM Worldwide Inc. (operating as Modi Media, Mumbai) as the Agency, and Murphy's Marketing Services Inc. (Papa Murphy's, New Delhi) as the Company — a take-and-bake pizza and food products business operating through corporate and franchised retail stores in North India. The agreement establishes a framework for the Agency to provide advertising and marketing services on a non-exclusive, project basis governed by individual Work Orders and Change Orders. Key features include 30-day invoice payment terms (with 1.5% per month interest on late payment), ownership of all deliverables by the Company as works made for hire under Section 17 of the Copyright Act, 1957, mutual indemnification obligations, a 1-year auto-renewing term with 90-day notice for termination, and a 2-year post-termination confidentiality obligation.",
    definitions: [
      {
        term: "Services",
        explanation: "All advertising and/or marketing projects authorised by the Company under mutually executed Work Orders and Change Orders."
      },
      {
        term: "Work Order",
        explanation: "A written authorisation issued by the Company to the Agency specifying the scope of services, timetable, deliverables, and compensation for a particular project."
      },
      {
        term: "Change Order",
        explanation: "A written modification to an existing Work Order that changes, amends, or supplements the agreed services or compensation."
      },
      {
        term: "Deliverables",
        explanation: "All outputs produced by the Agency for the Company, including media plans, brochures, ad materials, videos, email campaigns, and other marketing content — owned by the Company as works made for hire upon full payment."
      },
      {
        term: "Agency Elements",
        explanation: "Pre-existing know-how, tools, software, templates, and methodologies owned exclusively by the Agency prior to or independent of the agreement."
      },
      {
        term: "Confidential Information",
        explanation: "All non-public financial, operational, and technical information shared between parties; obligations survive for 2 years post-termination."
      },
      {
        term: "Indemnifying Party",
        explanation: "The party obligated to defend and hold harmless the other against third-party claims arising from that party's breach, IP infringement, or gross negligence."
      }
    ],
    provisions: [
      {
        section: "Clause 1",
        description: "Services, Work Orders, Change Orders: non-exclusive basis; Agreement terms prevail over Work Orders unless expressly stated otherwise"
      },
      {
        section: "Clause 2",
        description: "Invoices and Payments: 30-day payment cycle; 1.5% per month interest on overdue amounts beyond 10 days; right to suspend services for non-payment"
      },
      {
        section: "Clause 3",
        description: "Independent Contractor: no partnership, joint venture, employment, or agency relationship created"
      },
      {
        section: "Clause 4",
        description: "Termination: 1-year auto-renewing term; 90-day written notice to terminate; 30-day cure period for material breach"
      },
      {
        section: "Clause 5",
        description: "Deliverables: works made for hire under Section 17, Copyright Act, 1957; IP ownership transfers to Company upon full payment"
      },
      {
        section: "Clause 7",
        description: "Indemnification: mutual indemnification for IP infringement, breach, and gross negligence"
      },
      {
        section: "Clause 9",
        description: "Limitation of Liability: no consequential, punitive, or indirect damages; liability capped at fees paid; 1-year claims limitation"
      },
      {
        section: "Clause 10",
        description: "Confidentiality: 2-year post-termination obligation; return or destruction of confidential information"
      },
      {
        section: "Clause 12",
        description: "Force Majeure: excludes payment obligations; covers acts of God, war, cyber attacks, natural disasters"
      }
    ]
  },
  {
    ...
    introLine: "When medicine reaches its limits, the law must define the boundary of dignity.",
    icon: BookOpen,
    pdfLink: "/assets/uploads/Case-Brief-Harish-Rane-vs-UOI-5.pdf",
    synopsis: "This case brief documents the landmark Supreme Court judgment delivered on 11 March 2026 in Harish Rana v. Union of India and Ors., decided by a bench comprising Justice J.B. Pardiwala and Justice K.V. Viswanathan. Harish Rana suffered a severe head injury in an accidental fall in 2013, which left him in a permanent vegetative state with complete neurological impairment for over 13 years, with no possibility of recovery as confirmed by independent medical boards constituted by the Court. His family petitioned the Supreme Court seeking permission to withdraw life-sustaining treatment, arguing that continued artificial support merely prolonged biological existence without dignity. The Court allowed the withdrawal of life-sustaining treatment, reaffirming that Article 21 of the Constitution protects not just the right to live, but the right to live — and to die — with dignity. The judgment applied and strengthened the passive euthanasia framework established in Common Cause v. Union of India, subject to strict procedural safeguards including medical board evaluation and judicial oversight.",
    definitions: [
      {
        term: "Persistent Vegetative State (PVS)",
        explanation: "A medical condition in which a patient is alive but shows no signs of awareness or consciousness and has no meaningful interaction with the environment due to severe brain damage."
      },
      {
        term: "Passive Euthanasia",
        explanation: "The withdrawal or withholding of life-sustaining medical treatment (such as artificial nutrition, hydration, or ventilation) with the intent to allow a terminally ill or irreversibly incapacitated patient to die naturally. Distinguished from active euthanasia, which is not permitted in India."
      },
      {
        term: "Life-Sustaining Treatment",
        explanation: "Medical interventions such as mechanical ventilation, artificial nutrition and hydration, or cardiopulmonary resuscitation that artificially maintain biological functions when the body cannot do so independently."
      },
      {
        term: "Ratio Decidendi",
        explanation: "The binding legal reasoning or principle of a court's judgment on which the decision is based; as distinct from obiter dicta (observations not forming part of the binding ratio)."
      },
      {
        term: "Living Will (Advance Directive)",
        explanation: "A legal document in which a person specifies in advance the medical treatments they do or do not wish to receive if they become incapacitated — recognised by the Supreme Court in Common Cause v. Union of India."
      }
    ],
    provisions: [
      {
        section: "Article 21",
        description: "Right to Life and Personal Liberty; interpreted to include right to live and die with dignity"
      },
      { section: "Article 14", description: "Equality before law" },
      {
        section: "Aruna Ramchandra Shanbaug v. Union of India",
        description: "Recognised passive euthanasia in India under strict judicial supervision; family or hospital can petition court to withdraw treatment"
      },
      {
        section: "Common Cause v. Union of India (2018)",
        description: "Landmark ruling recognising the right to die with dignity as a fundamental right under Article 21; validated advance directives (living wills)"
      },
      {
        section: "Gian Kaur v. State of Punjab (1996)",
        description: "Distinguished the right to life under Article 21 from the right to die; clarified that right to life includes right to live with human dignity"
      }
    ]
  }
];
function App() {
  ...
  if (selectedDoc) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(DetailPage, { doc: selectedDoc, onBack: handleBack });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 bg-gradient-to-r from-transparent via-primary to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "border-b-2 border-border bg-white/80 backdrop-blur-sm sticky top-0 z-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-4 flex items-center justify-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Scale, { className: "w-5 h-5 text-primary", strokeWidth: 1.5 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-sm font-semibold text-foreground tracking-wide", children: "Anushka Sharma" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-border mx-1", children: "·" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: "Legal Portfolio" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "text-center px-6 pt-20 pb-16 max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-fade hero-fade-1 inline-flex items-center justify-center w-16 h-16 rounded-full border-2 border-primary/30 bg-secondary mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Feather, { className: "w-7 h-7 text-primary", strokeWidth: 1.5 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "hero-fade hero-fade-2 font-display text-5xl md:text-6xl font-bold text-foreground leading-tight mb-7", children: [
        "Anushka's ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-primary not-italic", children: "Legal" }),
        " ",
        "Portfolio"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-fade hero-fade-2 w-24 h-[2px] bg-gradient-to-r from-transparent via-primary to-transparent mx-auto mb-8" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hero-fade hero-fade-3 font-body text-base md:text-lg text-foreground/80 leading-relaxed mb-8 max-w-2xl mx-auto", children: "Before diving into my written submissions, take a moment to explore a quick introduction to the documents featured here. Each section offers a short synopsis, highlights key definitions and legal provisions, and gives you a glimpse of what the full document contains. Think of it as a small guide to make navigating these detailed legal drafts a little smoother and a lot more enjoyable." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-fade hero-fade-4 inline-flex items-center gap-3 bg-secondary/80 border border-border rounded-full px-6 py-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-primary flex-shrink-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-foreground/75 italic", children: [
          "All documents featured here are the original work of",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-primary not-italic", children: "Anushka Sharma" }),
          "."
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-10 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs font-semibold tracking-widest uppercase text-primary/60", children: "— Featured Documents —" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-5xl mx-auto px-6 pb-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: documents.slice(0, 3).map((doc) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        DocumentCard,
        {
          doc,
          index: doc.id,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6 max-w-2xl mx-auto", children: documents.slice(3).map((doc) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        DocumentCard,
        {
          doc,
          index: doc.id,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t-2 border-border bg-secondary/30 py-10 text-center px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-[2px] bg-gradient-to-r from-transparent via-primary to-transparent mx-auto mb-6" }),
